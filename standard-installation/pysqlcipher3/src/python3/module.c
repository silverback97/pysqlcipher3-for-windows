...
PyMODINIT_FUNC PyInit__sqlite3(void)
{
    ...
    if (!(pysqlite_Error = PyErr_NewException("pysqlcipher3.dbapi2" ".Error", PyExc_Exception, NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "Error", pysqlite_Error);

    if (!(pysqlite_Warning = PyErr_NewException("pysqlcipher3.dbapi2" ".Warning", PyExc_Exception, NULL))) {
        goto error;
    }
    ...
    if (!(pysqlite_InterfaceError = PyErr_NewException("pysqlcipher3.dbapi2" ".InterfaceError", pysqlite_Error, NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "InterfaceError", pysqlite_InterfaceError);

    if (!(pysqlite_DatabaseError = PyErr_NewException("pysqlcipher3.dbapi2" ".DatabaseError", pysqlite_Error, NULL))) {
        goto error;
    }
    ...
    if (!(pysqlite_InternalError = PyErr_NewException("pysqlcipher3.dbapi2" ".InternalError", pysqlite_DatabaseError, NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "InternalError", pysqlite_InternalError);

    if (!(pysqlite_OperationalError = PyErr_NewException("pysqlcipher3.dbapi2" ".OperationalError", pysqlite_DatabaseError, NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "OperationalError", pysqlite_OperationalError);

    if (!(pysqlite_ProgrammingError = PyErr_NewException("pysqlcipher3.dbapi2" ".ProgrammingError", pysqlite_DatabaseError, NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "ProgrammingError", pysqlite_ProgrammingError);

    if (!(pysqlite_IntegrityError = PyErr_NewException("pysqlcipher3.dbapi2" ".IntegrityError", pysqlite_DatabaseError,NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "IntegrityError", pysqlite_IntegrityError);

    if (!(pysqlite_DataError = PyErr_NewException("pysqlcipher3.dbapi2" ".DataError", pysqlite_DatabaseError, NULL))) {
        goto error;
    }
    PyDict_SetItemString(dict, "DataError", pysqlite_DataError);

    if (!(pysqlite_NotSupportedError = PyErr_NewException("pysqlcipher3.dbapi2" ".NotSupportedError", pysqlite_DatabaseError, NULL))) {
        goto error;
    }
...
error:
    if (PyErr_Occurred())
    {
        PyErr_SetString(PyExc_ImportError, "pysqlcipher3.dbapi2" ": init failed");
        Py_DECREF(module);
        module = NULL;
    }
    return module;
